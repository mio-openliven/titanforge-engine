...
class ProjectLocationTests(unittest.TestCase):
    def test_write_project_location_creates_draft_and_location_outputs(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            draft_review_html = (output_dir / "draft" / "review.html").read_text(encoding="utf-8")
        ...
        self.assertEqual(manifest["artifacts"]["structureTemplate"], "draft\\structure-template.nbt")
        ...
        self.assertIn("512 x 512 x 7", location_review_html)
        self.assertIn("/function titanforge:place_fixture", location_review_html)
        self.assertIn("/place template titanforge:fixture", location_review_html)
        self.assertIn("/function titanforge:clear_fixture", location_review_html)
