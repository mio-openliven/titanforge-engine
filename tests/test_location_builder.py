...
class LocationBuilderTests(unittest.TestCase):
    ...
    def test_build_location_pack_writes_static_review_page(self) -> None:
        ...
        self.assertIn("How To Read This Pack", review_html)
        self.assertIn("It is not where you change final world size or story layout.", review_html)
        self.assertIn("Start with terrain-color-preview.png", review_html)
        self.assertIn("Then open heightmap-preview.png", review_html)
        self.assertIn("Then read report.txt", review_html)
