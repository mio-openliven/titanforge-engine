...
class ProjectFirstMapTests(unittest.TestCase):
    def test_write_project_first_map_creates_starter_project_and_location_pack(self) -> None:
        ...
        self.assertEqual(manifest["artifacts"]["reviewPage"], "first-map\\location\\review.html")
        ...
        self.assertIn("Open first: first-map\\location\\review.html", summary)
    ...
    def test_first_map_cli_command(self) -> None:
        ...
        self.assertIn("Open first: first-map\\location\\review.html", stdout.getvalue())
