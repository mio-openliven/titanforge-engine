...
class ProjectDraftTests(unittest.TestCase):
    def test_write_project_draft_creates_expected_artifacts(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            fixture_summary = json.loads((output_dir / "fixture-summary.json").read_text(encoding="utf-8"))
            ...
            fixture_summary_exists = (output_dir / "fixture-summary.json").exists()
        ...
        self.assertTrue(fixture_summary_exists)
        ...
        self.assertIn("README.txt", datapack_zip_entries)
        ...
        self.assertIn('"fixtureSummary": "fixture-summary.json"', manifest_text)
    ...
    def test_project_draft_cli_command(self) -> None:
        ...
        self.assertIn("- fixture summary: fixture-summary.json", stdout.getvalue())
