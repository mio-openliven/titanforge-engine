...
from titanforge.exporters.minecraft_12111_datapack import (
    ...
    build_minecraft_datapack_readme_lines,
...
class MinecraftDatapackTests(unittest.TestCase):
    ...
    def test_build_fixture_command_lines_include_place_and_clear(self) -> None:
        ...
        lines = build_minecraft_fixture_command_lines(fixture)
    ...
    def test_unsupported_fixture_guides_warn_clearly(self) -> None:
        ...
        command_lines = build_minecraft_fixture_command_lines(fixture)
        readme_lines = build_minecraft_datapack_readme_lines(fixture)

        self.assertTrue(any("not supported" in line for line in command_lines))
        self.assertTrue(any("Do not run" in line for line in command_lines))
        self.assertTrue(any("not supported" in line for line in readme_lines))
        self.assertTrue(any("Do not run" in line for line in readme_lines))
