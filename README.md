...
- a first fixture-commands guide artifact with exact `/function` commands for testing;
- a first fixture-summary artifact with rough bounds and fill-command counts before world testing;
